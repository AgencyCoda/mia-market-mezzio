...
$app->route('/mia-market/store/order/list', [\Mia\Auth\Handler\AuthHandler::class, \Mia\Market\Middleware\StoreOnlyMiddleware::class, \Mia\Market\Handler\Order\ListByStoreHandler::class], ['POST', 'OPTIONS', 'HEAD'], 'mia_store.products');
