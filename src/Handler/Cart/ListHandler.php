...
use Mia\Market\Repository\MiaCartRepository;
 ...
 *                      property="response",
 *                      type="array",
 *                      @OA\Items(type="object", ref="#/components/schemas/Cart")
 *                  )
 *              }
 *          )
 *     ),
...
class ListHandler extends \Mia\Auth\Request\MiaAuthRequestHandler
{
    ...
    public function handle(\Psr\Http\Message\ServerRequestInterface $request): \Psr\Http\Message\ResponseInterface 
    {
        ...
        $configure->addWith('child');
        // Obtenemos información
        $rows = MiaCartRepository::fetchByConfigure($configure);
